...
class YelpSpider(Spider):
    ...
    def get_start_urls(self):
        url_list = {}
        start_urls = []
        with open('../dataset/mallsdata.csv', 'rb') as csvfile:
    ...
    # # test data
    # start_urls = [
    # "http://www.yelp.com/search?find_loc=ny&ns=1&find_desc=chanel",
    # 	"http://www.yelp.com/search?find_loc=ny&ns=1&find_desc=prada",
    # 	"http://www.yelp.com/search?find_loc=ny&ns=1&find_desc=enzo",
    # 	"http://www.yelp.com/search?find_loc=ny&ns=1&find_desc=h&m"
    # ]
